...
// CODE HERE
const helloBlackBackground = () =>{
    sayHelloButton.style.backgroundColor = "black";
}
sayHelloButton.addEventListener('mouseover', helloBlackBackground);
// PROBLEM 3
/*
...
// CODE HERE
const goodByeBlackBackground = () =>{
    sayHelloButton.style.backgroundColor = "#EFEFEF";
}
sayHelloButton.addEventListener('mouseout', goodByeBlackBackground);
// PROBLEM 4
/*
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/testString').then(res => {
...
const quereyRequest = () => {
    axios.get(`http://localhost:3000/query-test/?yeah=yeah/?no=no}`).then(res => {
        console.log(res.data);
    })
}
queryButton.addEventListener('click', quereyRequest);
...
//I got a 404 not found when I had no quieres
//For 2 It sent the first query and had the 2 query as a string
